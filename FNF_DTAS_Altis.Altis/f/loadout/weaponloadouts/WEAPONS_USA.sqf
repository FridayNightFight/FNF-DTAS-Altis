...
if (pRole == ROLE_AR) then {
  phx_loadout_automaticrifle_weapon = "fow_w_m1918a2";
  phx_loadout_automaticrifle_mag = "fow_20Rnd_762x63:15";
};
if (pRole == ROLE_MG) then {
  phx_loadout_mmg_weapon = "fow_w_m1919a6";
  phx_loadout_mmg_mag = "fow_50Rnd_762x63:8";
};
